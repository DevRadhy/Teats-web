  ...
  return (
    <div className={styles.container}>
      <div className={styles.gridContainer}>
        <div>
          <img src="https://images.unsplash.com/photo-1520201163981-8cc95007dd2a?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=334&q=80" alt="Product"/>
        </div>
